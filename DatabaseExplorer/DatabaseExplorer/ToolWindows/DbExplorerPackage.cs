//------------------------------------------------------------------------------
// <copyright file="DbExplorerPackage.cs" company="Company">
...
namespace DatabaseExplorer.ToolWindows
{
    ...
    {
        /// <summary>
        /// DbExplorerPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "a51d6ed5-423a-4fe3-a170-e26b12f38d60";

        /// <summary>
        /// Initializes a new instance of the <see cref="DbExplorer"/> class.
        /// </summary>
        public DbExplorerPackage()
        {
