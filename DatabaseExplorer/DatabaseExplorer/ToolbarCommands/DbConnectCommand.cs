...
{
    internal sealed class DbConnectCommand
    {
        ...
        private DbConnectCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DbConnectCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new DbConnectCommand(package);
        }
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            var toolbarbtnCmdID = new CommandID(new Guid(DbConnectCommand.guidDbExplorerPackageCmdSet),
                DbConnectCommand.cmdidDbConnect);
            var menuItem = new MenuCommand(new EventHandler(
                ButtonHandler1), toolbarbtnCmdID);
            mcs.AddCommand(menuItem);
        }

        private void ButtonHandler1(object sender, EventArgs arguments)
        {
